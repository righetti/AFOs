...
K = 10
t, phi, omega, alpha = simulate_pool(N, K, lamb, eta, amplitudes, frequencies, phases, dt=10e-5)
...
K = 10000
t, phi, omega, alpha = simulate_pool(N, K, lamb, eta, amplitudes, frequencies, phases, dt=10e-8)
output = get_pool_output(phi, alpha)
plot_results(frequencies, amplitudes, omega, alpha, in_signal, output, N)
